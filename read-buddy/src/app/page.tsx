...
export default function Home() {
    return (
        <>
            <MaxWidthWrapper //basic layout of the stuff 
                ...
                <h1 className='max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl'>
                    ...
                    using the power of GPT-3.5
                </h1>
                <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
                    It allows you to ask any questions regarding your PDF documents.
                    Simply upload your file and start right away.
                </p>
            ...
            {/** now the value proposition section  */}
            <div>
                <div className='relative isolate'>
                    <div //this is gonna be the greadient section ,purely decorational 
                        aria-hidden='true'//this is for the screen reader 
                        className='pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80'>
                        <div
                            style={{
                                clipPath:// the style path of the greadient 
                    ...
                    <div>
                        <div // the image section of our product 
                            className='mx-auto max-w-6xl px-6 lg:px-8'>
                            <div className='mt-16 flow-root sm:mt-24'>
                                <div //wrapper div for image 
                    ...
                    <div // decorator with some sbtl changes 
                        aria-hidden='true'
                        className='pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80'>
                        <div
                            style={{
                ...
                <div className='mb-12 px-6 lg:px-8'>
                    <div className='mx-auto max-w-2xl sm:text-center'>
                        ...
                        <p className='mt-4 text-lg text-gray-600'>
                            Find your answers from your PDFs using the power Ai.
                        </p>
                    </div>
                </div>
