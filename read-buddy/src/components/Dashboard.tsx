...
// almost complete ,just need to revisit after the stripe integration 
...
const Dashboard = () => {
  ...
  return (//basic layout of our dashboard 
    <main className='mx-auto max-w-7xl md:p-10'>
      ...
      {files && files?.length !== 0 ? (// if we have one file or more 
        <ul //this part for showing files 
